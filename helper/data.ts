export const data = [
  {
    ...
    about_instructor: {
      html_content:
        "<p>Lorem ipsum text about the instructor's background and philosophy.</p><p>Lorem ipsum text about the instructor's background and philosophy.</p>",
    },
    testimonial: {
...
export interface IData {
  ...
  course: {
    ...
    about: {
      html_content: JSX.Element | string;
    };
    what_to_expect: {
      html_content: JSX.Element | string;
    };
